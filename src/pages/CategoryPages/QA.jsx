...
const QA = () => {
  ...
  useEffect(() => {
    const fetchingPosts = async () => {
      const request = await fetch(`${VITE_API_BASE_URL}/categories/qa`, {
        method: "GET",
  ...
  return (
    <React.Fragment>
      <h1 className="flex justify-center items-center text-xl font-medium text-sky-800 py-6 sm:text-2xl md:text-4xl lg:text-5xl">Quality Assurance Posts</h1>
